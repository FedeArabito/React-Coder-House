...
var qi = (g, a, o) => a in g ? Ni(g, a, { enumerable: true, configurable: true, writable: true, value: o }) : g[a] = o;
var $ = (g, a, o) => (qi(g, typeof a != "symbol" ? a + "" : a, o), o);
var Qe = class {
...
var _e = { name: "@lottiefiles/dotlottie-web", version: "0.23.1", type: "module", description: "Lottie and DotLottie player for the web", repository: { type: "git", url: "git+https://github.com/LottieFiles/dotlottie-web.git", directory: "packages/web" }, homepage: "https://github.com/LottieFiles/dotlottie-web#readme", bugs: "https://github.com/LottieFiles/dotlottie-web/issues", author: "LottieFiles", contributors: ["Abdelrahman Ashraf <a.theashraf@gmail.com>"], license: "MIT", main: "dist/index.cjs", module: "dist/index.js", types: "dist/index.d.ts", files: ["dist"], keywords: ["dotlottie", "lottie", "player", "animation", "web", "canvas", "javascript", "thorvg"], scripts: { build: "tsup", dev: "tsup --watch", lint: "eslint --fix .", "stats:eslint": "cross-env TIMING=1 eslint .", "stats:ts": "tsc -p tsconfig.build.json --extendedDiagnostics", test: "vitest run --browser.headless", "test:coverage": "vitest run --browser.headless --coverage", "test:watch": "vitest", "type-check": "tsc --noEmit" }, devDependencies: { "@types/node": "^20.10.5", "@vitest/browser": "^1.2.2 ", "@vitest/coverage-istanbul": "^1.2.2", "cross-env": "7.0.3", tsup: "8.0.1", typescript: "5.0.4", vitest: "^1.2.2", webdriverio: "^8.32.0" }, publishConfig: { access: "public" } };
var Xi = (() => {
  var g = typeof document < "u" ? document.currentScript?.src : void 0;
  return function(a = {}) {
    var o = a, _, E, ie = new Promise((e, t) => {
      _ = e, E = t;
    }), me = Object.assign({}, o), ot = "./this.program", st = true, U = "";
    function er(e) {
      return o.locateFile ? o.locateFile(e, U) : U + e;
    }
    typeof document < "u" && document.currentScript && (U = document.currentScript.src), g && (U = g), U.startsWith("blob:") ? U = "" : U = U.substr(0, U.replace(/[?#].*/, "").lastIndexOf("/") + 1);
    var nr = o.print || console.log.bind(console), Z = o.printErr || console.error.bind(console);
    Object.assign(o, me), me = null, o.arguments && o.arguments, o.thisProgram && (ot = o.thisProgram), o.quit && o.quit;
    var ae;
    o.wasmBinary && (ae = o.wasmBinary);
    var ge, lt = false, O, L, Q, oe, A, w, ut, dt;
    function ct() {
      var e = ge.buffer;
      o.HEAP8 = O = new Int8Array(e), o.HEAP16 = Q = new Int16Array(e), o.HEAPU8 = L = new Uint8Array(e), o.HEAPU16 = oe = new Uint16Array(e), o.HEAP32 = A = new Int32Array(e), o.HEAPU32 = w = new Uint32Array(e), o.HEAPF32 = ut = new Float32Array(e), o.HEAPF64 = dt = new Float64Array(e);
    }
    var ft = [], vt = [], pt = [];
    function or() {
      if (o.preRun)
    ...
    var q = 0, se = null;
    function fr(e) {
      q++, o.monitorRunDependencies?.(q);
    }
    function vr(e) {
      if (q--, o.monitorRunDependencies?.(q), q == 0 && se) {
        var t = se;
        se = null, t();
      }
    }
    function be(e) {
      o.onAbort?.(e), e = "Aborted(" + e + ")", Z(e), lt = true, e += ". Build with -sASSERTIONS for more info.";
    ...
    function mr() {
      ...
      if (o.instantiateWasm)
        try {
          ...
          Z(`Module.instantiateWasm callback failed with error: ${n}`), E(n);
        }
      return _r(ae, ee, e, r).catch(E), {};
    }
    var De = (e) => {
      for (; e.length > 0; )
        e.shift()(o);
    ...
    var D = (e) => Vt(e), I = () => zt(), yt = typeof TextDecoder < "u" ? new TextDecoder("utf8") : void 0, gt = (e, t, r) => {
    ...
    var re = {}, X = {}, Te = {}, Tt, Ee = (e) => {
      ...
      t.forEach((l, d) => {
        X.hasOwnProperty(l) ? i[d] = X[l] : (s.push(l), re.hasOwnProperty(l) || (re[l] = []), re[l].push(() => {
          i[d] = X[l], ++u, u === s.length && n(i);
        }));
      }), s.length === 0 && n(i);
    }, Rr = (e) => {
      var t = we[e];
      ...
      N([e], s, (u) => {
        ...
        return i.forEach((d, f) => {
          var v = d.fieldName, m = u[f], h = d.getter, C = d.getterContext, F = u[f + i.length], W = d.setter, S = d.setterContext;
          l[v] = { read: (P) => m.fromWireType(h(C, P)), write: (P, c) => {
            var p = [];
            W(S, P, F.toWireType(p, c)), je(p);
          } };
        ...
        }, argPackAdvance: H, readValueFromPointer: le, destructorFunction: n }];
      });
    }, Sr = (e, t, r, n, i) => {
    }, xr = () => {
    ...
    var H = 8, Ir = (e, t, r, n) => {
      t = M(t), B(e, { name: t, fromWireType: function(i) {
        return !!i;
      }, toWireType: function(i, s) {
        return s ? r : n;
      }, argPackAdvance: H, readValueFromPointer: function(i) {
    ...
    }, Lt = {}, Or = () => Object.keys(ce).length, Ur = () => {
      var e = [];
      for (var t in ce)
      ...
      o.getInheritedInstanceCount = Or, o.getLiveInheritedInstances = Ur, o.flushPendingDeletes = Ue, o.setDelayFunction = Br;
    }, ce = {}, Vr = (e, t) => {
      for (t === void 0 && y("ptr should not be undefined"); e.baseClass; )
        t = e.upcast(t), e = e.baseClass;
      return t;
    }, zr = (e, t) => (t = Vr(e, t), ce[t]), Fe = (e, t) => {
    ...
    function Yr(e) {
      ...
      var s = this.registeredClass.getActualType(t), u = Lt[s];
      if (!u)
        return i.call(this);
      var l;
    ...
    var ve = (e, t) => Object.defineProperty(t, "name", { value: e }), Mt = (e, t, r) => {
      ...
      o.hasOwnProperty(e) ? ((r === void 0 || o[e].overloadTable !== void 0 && o[e].overloadTable[r] !== void 0) && y(`Cannot register public name '${e}' twice`), Mt(o, e, e), o.hasOwnProperty(r) && y(`Cannot register multiple overloads of a function with the same number of arguments (${r})!`), o[e].overloadTable[r] = t) : (o[e] = t, r !== void 0 && (o[e].numArguments = r));
    }, qr = 48, Gr = 57, Xr = (e) => {
      if (e === void 0)
        return "_unknown";
    ...
    var en = () => {
      ...
      }, argPackAdvance: H, readValueFromPointer: le, fromWireType: Yr });
    };
    function pe(e, t, r, n, i, s, u, l, d, f, v) {
      this.name = e, this.registeredClass = t, this.isReference = r, this.isConst = n, this.isSmartPointer = i, this.pointeeType = s, this.sharingPolicy = u, this.rawGetPointee = l, this.rawConstructor = d, this.rawShare = f, this.rawDestructor = v, !i && t.baseClass === void 0 ? n ? (this.toWireType = Kr, this.destructorFunction = null) : (this.toWireType = Qr, this.destructorFunction = null) : this.toWireType = Zr;
    }
    var At = (e, t, r) => {
      o.hasOwnProperty(e) || Ee("Replacing nonexistent public symbol"), o[e].overloadTable !== void 0 && r !== void 0 ? o[e].overloadTable[r] = t : (o[e] = t, o[e].argCount = r);
    }, tn = (e, t, r) => {
      e = e.replace(/p/g, "i");
      var n = o["dynCall_" + e];
      return n(t, ...r);
...
` + i.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    }, on = (e, t, r, n, i, s, u, l, d, f, v, m, h) => {
      v = M(v), s = j(i, s), l && (l = j(u, l)), f && (f = j(d, f)), h = j(m, h);
      var C = Xr(v);
      Be(C, function() {
        ...
        F = F[0];
        var W, S;
        n ? (W = F.registeredClass, S = W.instancePrototype) : S = $e.prototype;
        var P = ve(v, function(...Ze) {
        ...
        }), c = Object.create(S, { constructor: { value: P } });
        P.prototype = c;
        var p = new Jr(v, P, c, h, W, s, l, f);
        ...
        return Lt[e] = { pointerType: T, constPointerType: Y }, At(C, P), [x, T, Y];
      });
    }, Ve = (e, t) => {
      for (var r = [], n = 0; n < e; n++)
        r.push(w[t + n * 4 >> 2]);
    ...
    function ze(e, t, r, n, i, s) {
      ...
      var l = t[1] !== null && r !== null, d = sn(t), f = t[0].name !== "void", v = u - 2, m = new Array(v), h = [], C = [], F = function(...W) {
        ...
        for (var P = 0; P < v; ++P)
          m[P] = t[P + 2].toWireType(C, W[P]), h.push(m[P]);
        var c = n(...h);
        function p(x) {
          if (d)
            je(C);
    ...
    var ln = (e, t, r, n, i, s) => {
      ...
      i = j(n, i), N([], [e], (l) => {
        ...
        }, N([], u, (f) => (f.splice(1, 0, null), l.registeredClass.constructor_body[t - 1] = ze(d, f, null, i, s), [])), [];
      });
    }, xt = (e) => {
      e = e.trim();
      let t = e.indexOf("(");
      ...
      t = M(t), t = xt(t), s = j(i, s), N([], [e], (v) => {
        ...
        var C = v.registeredClass.instancePrototype, F = C[t];
        return F === void 0 || F.overloadTable === void 0 && F.className !== v.name && F.argCount === r - 2 ? (h.argCount = r - 2, h.className = v.name, C[t] = h) : (Mt(C, t, m), C[t].overloadTable[r - 2] = h), N([], f, (W) => {
          var S = ze(m, W, v, s, u);
          return C[t].overloadTable === void 0 ? (S.argCount = r - 2, C[t] = S) : C[t].overloadTable[r - 2] = S, [];
        }), [];
      });
    }, Ye = [], V = [], Ne = (e) => {
      e > 9 && --V[e + 1] === 0 && (V[e] = void 0, Ye.push(e));
    }, dn = () => V.length / 2 - 5 - Ye.length, cn = () => {
      V.push(0, 1, void 0, 1, null, 1, true, 1, false, 1), o.count_emval_handles = dn;
    }, J = { toValue: (e) => (e || y("Cannot use deleted val. handle = " + e), V[e]), toHandle: (e) => {
      switch (e) {
        case void 0:
          return 2;
        case null:
      ...
      var t = J.toValue(e);
      return Ne(e), t;
    }, toWireType: (e, t) => J.toHandle(t), argPackAdvance: H, readValueFromPointer: le, destructorFunction: null }, Dt = (e) => B(e, fn), vn = (e, t, r) => {
      switch (t) {
        case 1:
          return r ? function(n) {
      ...
      i.values = {}, B(e, { name: t, constructor: i, fromWireType: function(s) {
        return this.constructor.values[s];
      }, toWireType: (s, u) => u.value, argPackAdvance: H, readValueFromPointer: vn(t, r, n), destructorFunction: null }), Be(t, i);
    }, qe = (e, t) => {
      var r = X[e];
      ...
      var n = qe(e, "enum");
      t = M(t);
      var i = n.constructor, s = Object.create(n.constructor.prototype, { value: { value: r }, constructor: { value: ve(`${n.name}_${t}`, function() {
      }) } });
      i.values[r] = s, i[t] = s;
    }, Ge = (e) => {
      if (e === null)
      ...
      t = M(t), B(e, { name: t, fromWireType: (n) => n, toWireType: (n, i) => i, argPackAdvance: H, readValueFromPointer: _n(t, r), destructorFunction: null });
    }, yn = (e, t, r, n, i, s, u) => {
      var l = Ve(t, r);
      e = M(e), e = xt(e), i = j(n, i), Be(e, function() {
        Pe(`Cannot call ${e} due to unbound types`, l);
      }, t - 1), N([], l, (d) => {
        var f = [d[0], null].concat(d.slice(1));
        return At(e, ze(e, f, null, i, s), t - 1), [];
      });
    }, gn = (e, t, r) => {
      switch (t) {
        case 1:
          return r ? (n) => O[n] : (n) => L[n];
        case 2:
      ...
      }, B(e, { name: t, fromWireType: s, toWireType: f, argPackAdvance: H, readValueFromPointer: gn(t, r, n !== 0), destructorFunction: null });
    }, Cn = (e, t, r) => {
      ...
      r = M(r), B(e, { name: r, fromWireType: s, argPackAdvance: H, readValueFromPointer: s }, { ignoreDuplicateRegistrations: true });
    }, wn = (e, t) => {
      Dt(e);
    }, Tn = (e, t, r, n, i, s, u, l, d, f, v, m) => {
      r = M(r), s = j(i, s), l = j(u, l), f = j(d, f), m = j(v, m), N([e], [t], (h) => {
        h = h[0];
        var C = new pe(r, h.registeredClass, false, false, true, h, n, s, l, f, m);
        return [C];
      });
    }, En = (e, t) => {
      t = M(t);
      var r = t === "std::string";
      B(e, { name: t, fromWireType(n) {
        var i = w[n >> 2], s = n + 4, u;
        if (r)
        ...
        u || i instanceof Uint8Array || i instanceof Uint8ClampedArray || i instanceof Int8Array || y("Cannot pass non-string to std::string"), r && u ? s = Ct(i) : s = i.length;
        var l = Ke(4 + s + 1), d = l + 4;
        if (w[l >> 2] = s, r && u)
          $r(i, d, s + 1);
        else if (u)
          for (var f = 0; f < s; ++f) {
            var v = i.charCodeAt(f);
            v > 255 && (z(d), y("String has UTF-16 code units that do not fit in 8 bits")), L[d + f] = v;
          }
        else
          for (var f = 0; f < s; ++f)
            L[d + f] = i[f];
      ...
      for (var r = e, n = r >> 1, i = n + t / 2; !(n >= i) && oe[n]; )
        ++n;
      if (r = n << 1, r - e > 32 && It)
        return It.decode(L.subarray(e, r));
      ...
      r = M(r);
      var n, i, s, u;
      t === 2 ? (n = Fn, i = $n, u = Pn, s = (l) => oe[l >> 1]) : t === 4 && (n = Ln, i = Mn, u = An, s = (l) => w[l >> 2]), B(e, { name: r, fromWireType: (l) => {
        for (var d = w[l >> 2], f, v = l + 4, m = 0; m <= d; ++m) {
          var h = l + 4 + m * t;
          if (m == d || s(h) == 0) {
            var C = h - v, F = n(v, C);
            f === void 0 ? f = F : (f += "\0", f += F), v = h + t;
          }
        }
        return z(l), f;
      }, toWireType: (l, d) => {
        ...
        return w[v >> 2] = f / t, i(d, v + 4, f + t), l !== null && l.push(z, v), v;
      }, argPackAdvance: H, readValueFromPointer: le, destructorFunction(l) {
        z(l);
      } });
    }, Rn = (e, t, r, n, i, s) => {
      we[e] = { name: M(t), rawConstructor: j(r, n), rawDestructor: j(i, s), fields: [] };
    }, Sn = (e, t, r, n, i, s, u, l, d, f) => {
      we[e].fields.push({ fieldName: M(t), getterReturnType: r, getter: j(n, i), getterContext: s, setterArgumentType: u, setter: j(l, d), setterContext: f });
    }, xn = (e, t) => {
      t = M(t), B(e, { isVoid: true, name: t, argPackAdvance: 0, fromWireType: () => {
      }, toWireType: (r, n) => {
      } });
    }, Dn = (e, t, r) => L.copyWithin(e, t, t + r), In = () => {
      throw 1 / 0;
      ...
      return r;
    }, Un = Reflect.construct, Bn = (e, t, r) => {
      var n = [], i = e.toWireType(n, r);
      return n.length && (w[t >> 2] = J.toHandle(n)), i;
    }, Hn = (e, t, r) => {
      var n = On(e, t), i = n.shift();
      e--;
      var s = new Array(e), u = (d, f, v, m) => {
        for (var h = 0, C = 0; C < e; ++C)
          s[C] = n[C].readValueFromPointer(m + h), h += n[C].argPackAdvance;
        var F = r === 1 ? Un(f, s) : f.apply(d, s);
        return Bn(i, v, F);
    ...
    var qn = () => 2147483648, Gn = (e) => {
      ...
      for (var n = (d, f) => d + (f - d % f) % f, i = 1; i <= 4; i *= 2) {
        ...
        var u = Math.min(r, n(Math.max(e, s), 65536)), l = Gn(u);
        if (l)
          return true;
      }
      return false;
    ...
    var ii = [null, [], []], ai = (e, t) => {
      ...
      be("initRandomDevice");
    }, Wt = (e) => (Wt = si())(e), li = (e, t) => (Wt(L.subarray(e, e + t)), 0), Le = (e) => e % 4 === 0 && (e % 100 !== 0 || e % 400 === 0), ui = (e, t) => {
      ...
      for (var r = new Date(e.getTime()); t > 0; ) {
        var n = Le(r.getFullYear()), i = r.getMonth(), s = (n ? Ot : Ut)[i];
        if (t > s - r.getDate())
    ...
    function ci(e, t, r) {
      var n = r > 0 ? r : Ct(e) + 1, i = new Array(n), s = wt(e, i, 0, i.length);
    ...
    var fi = (e, t) => {
      ...
      function W(c) {
        var p = di(new Date(c.tm_year + 1900, 0, 1), c.tm_yday), x = new Date(p.getFullYear(), 0, 4), T = new Date(p.getFullYear() + 1, 0, 4), Y = F(x), Ae = F(T);
      ...
      }, "%j": (c) => h(c.tm_mday + ui(Le(c.tm_year + 1900) ? Ot : Ut, c.tm_mon - 1), 3), "%m": (c) => h(c.tm_mon + 1, 2), "%M": (c) => h(c.tm_min, 2), "%n": () => `
`, "%p": (c) => c.tm_hour >= 0 && c.tm_hour < 12 ? "AM" : "PM", "%S": (c) => h(c.tm_sec, 2), "%t": () => "	", "%u": (c) => c.tm_wday || 7, "%U": (c) => {
        ...
        if ((c.tm_wday + 371 - c.tm_yday - 2) % 7 <= 2 && p++, p) {
          if (p == 53) {
            ...
            T != 4 && (T != 3 || !Le(c.tm_year)) && (p = 1);
          }
        } else {
          p = 52;
          var x = (c.tm_wday + 7 - c.tm_yday - 1) % 7;
          (x == 4 || x == 5 && Le(c.tm_year % 400 - 1)) && p++;
        }
        return h(p, 2);
      }, "%w": (c) => c.tm_wday, "%W": (c) => {
      ...
      u = u.replace(/\0\0/g, "%");
      var P = ci(u, false);
      return P.length > t ? 0 : (fi(P, e), P.length - 1);
    }, pi = (e, t, r, n, i) => vi(e, t, r, n);
    Tt = o.InternalError = class extends Error {
      constructor(t) {
        super(t), this.name = "InternalError";
      }
    }, xr(), ne = o.BindingError = class extends Error {
      constructor(t) {
        super(t), this.name = "BindingError";
      }
    }, Nr(), Hr(), en(), Rt = o.UnboundTypeError = an(Error, "UnboundTypeError"), cn();
    var hi = { c: yr, d: Cr, q: Tr, h: gr, E: Er, W: Fr, T: Pr, X: Lr, U: Mr, D: Ar, V: kr, A: Rr, O: Sr, ea: Ir, z: on, x: ln, i: un, da: Dt, B: pn, n: hn, I: mn, K: yn, p: bn, k: Cn, L: wn, ka: Tn, J: En, y: kn, u: Rn, m: Sn, fa: xn, Y: Dn, P: In, ia: jn, R: Ne, ha: Hn, ja: Vn, ga: zn, t: Yn, ca: Nn, l: jt, S: Xn, Z: Zn, _: Qn, w: ei, C: ti, N: ni, v: oi, $: li, F: Vi, j: Ii, g: Di, e: Hi, ba: Ri, s: Bi, G: Oi, r: Wi, b: ki, a: Si, f: xi, o: Ui, H: ji, aa: zi, M: Yi, Q: pi }, b = mr(), Ke = (e) => (Ke = b.na)(e), Bt = (e) => (Bt = b.oa)(e), z = (e) => (z = b.qa)(e), R = (e, t) => (R = b.ra)(e, t), Ht = (e) => (Ht = b.sa)(e), Vt = (e) => (Vt = b.ta)(e), zt = () => (zt = b.ua)(), Yt = (e, t, r) => (Yt = b.va)(e, t, r), Nt = (e) => (Nt = b.wa)(e);
    o.dynCall_iijj = (e, t, r, n, i, s) => (o.dynCall_iijj = b.xa)(e, t, r, n, i, s);
    o.dynCall_vijj = (e, t, r, n, i, s) => (o.dynCall_vijj = b.ya)(e, t, r, n, i, s);
    o.dynCall_jiii = (e, t, r, n) => (o.dynCall_jiii = b.za)(e, t, r, n);
    o.dynCall_jii = (e, t, r) => (o.dynCall_jii = b.Aa)(e, t, r);
    var qt = o.dynCall_viiij = (e, t, r, n, i, s) => (qt = o.dynCall_viiij = b.Ba)(e, t, r, n, i, s);
    o.dynCall_jiji = (e, t, r, n, i) => (o.dynCall_jiji = b.Ca)(e, t, r, n, i);
    o.dynCall_viijii = (e, t, r, n, i, s, u) => (o.dynCall_viijii = b.Da)(e, t, r, n, i, s, u);
    o.dynCall_iiiiij = (e, t, r, n, i, s, u) => (o.dynCall_iiiiij = b.Ea)(e, t, r, n, i, s, u);
    o.dynCall_iiiiijj = (e, t, r, n, i, s, u, l, d) => (o.dynCall_iiiiijj = b.Fa)(e, t, r, n, i, s, u, l, d);
    o.dynCall_iiiiiijj = (e, t, r, n, i, s, u, l, d, f) => (o.dynCall_iiiiiijj = b.Ga)(e, t, r, n, i, s, u, l, d, f);
    function ki(e, t) {
      var r = I();
      try {
        k(e)(t);
    ...
    function Bi(e, t, r, n, i, s) {
      var u = I();
      try {
        return k(e)(t, r, n, i, s);
      } catch (l) {
        if (D(u), l !== l + 0)
          throw l;
        R(1, 0);
    ...
    function Gt() {
      if (q > 0 || (or(), q > 0))
        return;
      function e() {
        Me || (Me = true, o.calledRun = true, !lt && (sr(), _(o), o.onRuntimeInitialized && o.onRuntimeInitialized(), lr()));
      }
...
var K = class {
  ...
  static async _loadWithBackup() {
    return this._ModulePromise || (this._ModulePromise = this._tryLoad(this._wasmURL).catch(async (a) => {
      let o = `https://unpkg.com/${_e.name}@${_e.version}/dist/dotlottie-player.wasm`;
      console.warn(`Trying backup URL for WASM loading: ${o}`);
      try {
...
$(K, "_ModulePromise", null), $(K, "_wasmURL", `https://cdn.jsdelivr.net/npm/${_e.name}@${_e.version}/dist/dotlottie-player.wasm`);
var Re = class {
  constructor() {
  ...
  addEventListener(a, o) {
    ...
    _ || (_ = /* @__PURE__ */ new Set(), this._eventListeners.set(a, _)), _.add(o);
  }
  removeEventListener(a, o) {
    let _ = this._eventListeners.get(a);
    _ && (o ? (_.delete(o), _.size === 0 && this._eventListeners.delete(a)) : this._eventListeners.delete(a));
  }
  dispatch(a) {
...
var it = (g, a) => {
  ...
  return o.push_back(g[0]), o.push_back(g[1]), o;
};
var at = (g, a) => {
  let o = new a.VectorFloat();
  return g.length !== 2 || (o.push_back(g[0]), o.push_back(g[1])), o;
};
var Kt = class {
  constructor(a) {
    $(this, "_canvas");
    ...
    this._canvas = a.canvas, this._context = this._canvas.getContext("2d"), this._eventManager = new Re(), this._frameManager = new ke(), this._renderConfig = a.renderConfig ?? {}, K.load().then((o) => {
      this._wasmModule = o, this._dotLottieCore = new o.DotLottiePlayer({ autoplay: a.autoplay ?? false, backgroundColor: 0, loopAnimation: a.loop ?? false, mode: rt(a.mode ?? "forward", o), segment: at(a.segment ?? [], o), speed: a.speed ?? 1, useFrameInterpolation: a.useFrameInterpolation ?? true, marker: a.marker ?? "", layout: a.layout ? { align: it(a.layout.align, o), fit: nt(a.layout.fit, o) } : o.createDefaultLayout() }), a.data ? this._loadFromData(a.data) : a.src && this._loadFromSrc(a.src), a.backgroundColor && this.setBackgroundColor(a.backgroundColor);
    }).catch((o) => {
  ...
  _loadFromSrc(a) {
    async function o() {
      ...
      let E = (_.headers.get("content-type") ?? "").trim(), ie;
      return ["application/json", "text/plain"].some((me) => E.startsWith(me)) ? ie = await _.text() : ie = await _.arrayBuffer(), ie;
    }
    o().then((_) => {
  ...
  _loadFromData(a) {
    if (this._dotLottieCore === null)
      return;
    let o = this._canvas.width, _ = this._canvas.height, E = false;
    if (typeof a == "string")
      E = this._dotLottieCore.loadAnimationData(a, o, _);
    else if (a instanceof ArrayBuffer)
      E = this._dotLottieCore.loadDotLottieData(a, o, _);
    else if (typeof a == "object")
      E = this._dotLottieCore.loadAnimationData(JSON.stringify(a), o, _);
    else {
  ...
  _render() {
    ...
    if (this._dotLottieCore.render()) {
      let o = this._dotLottieCore.buffer(), _ = new Uint8ClampedArray(o, 0, this._canvas.width * this._canvas.height * 4), E = null;
      return typeof ImageData > "u" ? (E = this._context.createImageData(this._canvas.width, this._canvas.height), E.data.set(_)) : E = new ImageData(_, this._canvas.width, this._canvas.height), this._context.putImageData(E, 0, 0), this._eventManager.dispatch({ type: "render", currentFrame: this._dotLottieCore.currentFrame() }), true;
    }
    return false;
  }
  _draw() {
  ...
  resize() {
    if (!tt || !(this._canvas instanceof HTMLCanvasElement))
      return;
    let a = this._renderConfig.devicePixelRatio || window.devicePixelRatio || 1, { height: o, width: _ } = this._canvas.getBoundingClientRect();
    this._canvas.width = _ * a, this._canvas.height = o * a, this._dotLottieCore?.resize(this._canvas.width, this._canvas.height) && this._render();
  }
  setSegment(a, o) {
    this._dotLottieCore === null || this._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), segment: at([a, o], this._wasmModule) });
  }
  setMode(a) {
  ...
  setViewport(a, o, _, E) {
    return this._dotLottieCore === null ? false : this._dotLottieCore.setViewport(a, o, _, E);
  }
  static setWasmUrl(a) {
    K.setWasmUrl(a);
  }
...
var useDotLottie = (config) => {
  ...
  const setCanvasRef = useCallback(
    (canvas) => {
      if (canvas) {
        const dotLottieInstance = new Kt({
          ...config,
          canvas
        });
  ...
  useEffect(() => {
    if (!dotLottie)
      return;
    if (typeof config?.useFrameInterpolation === "boolean" && config.useFrameInterpolation !== dotLottie.useFrameInterpolation && dotLottie.isLoaded) {
  ...
  useEffect(() => {
    ...
    config.segment.length === 2 && dotLottie.isLoaded) {
